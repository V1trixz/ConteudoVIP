...
vi.mock("../services/subscriptions", () => ({
  processLofyPayCompletion: vi.fn(),
...
import { processLofyPayCompletion } from "../services/subscriptions";
import { lofypayWebhook } from "./integrations";
...
describe("webhook da LofyPay", () => {
  ...
  it("aceita repetições idempotentes quando o processamento já foi concluído", async () => {
    ...
    expect(processLofyPayCompletion).toHaveBeenCalledWith(payment.providerTransactionId);
  });
});
